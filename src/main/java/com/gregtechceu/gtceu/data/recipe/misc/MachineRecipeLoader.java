...
public class MachineRecipeLoader {
    ...
    private static void registerAssemblerRecipes(Consumer<FinishedRecipe> provider) {
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_bronze_bricks").EUt(16).inputItems(plate, Bronze, 6)
                ...
                .outputItems(GTBlocks.CASING_BRONZE_BRICKS.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_invar_heatproof").EUt(16).inputItems(plate, Invar, 6)
                ...
                .outputItems(GTBlocks.CASING_INVAR_HEATPROOF.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50).addMaterialInfo(true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_steel_solid").EUt(16).inputItems(plate, Steel, 6)
                .inputItems(frameGt, Steel).circuitMeta(6)
                .outputItems(GTBlocks.CASING_STEEL_SOLID.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50).addMaterialInfo(true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_aluminium_frostproof").EUt(16).inputItems(plate, Aluminium, 6)
                ...
                .outputItems(
                        GTBlocks.CASING_ALUMINIUM_FROSTPROOF.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50).addMaterialInfo(true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_tungsteensteel_robust").EUt(16).inputItems(plate, TungstenSteel, 6)
                ...
                .outputItems(
                        GTBlocks.CASING_TUNGSTENSTEEL_ROBUST.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50).addMaterialInfo(true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_stainless_clean").EUt(16).inputItems(plate, StainlessSteel, 6)
                ...
                .outputItems(GTBlocks.CASING_STAINLESS_CLEAN.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50).addMaterialInfo(true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_titanium_stable").EUt(16).inputItems(plate, Titanium, 6)
                ...
                .outputItems(GTBlocks.CASING_TITANIUM_STABLE.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50).addMaterialInfo(true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_hsse_sturdy").EUt(16).inputItems(plate, HSSE, 6)
                ...
                .outputItems(GTBlocks.CASING_HSSE_STURDY.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50).addMaterialInfo(true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_palladium_substation").EUt(16).inputItems(plate, Palladium, 6)
                ...
                .outputItems(
                        GTBlocks.CASING_PALLADIUM_SUBSTATION.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50).addMaterialInfo(true).save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_bronze_firebox")
                ...
                .outputItems(GTBlocks.FIREBOX_BRONZE, RecipeConfig.CASINGS_PER_CRAFT.get())
                .addMaterialInfo(true, true)
                .duration(100)
                .EUt(VA[LV])
                .save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_steel_firebox")
                ...
                .outputItems(GTBlocks.FIREBOX_STEEL, RecipeConfig.CASINGS_PER_CRAFT.get())
                .addMaterialInfo(true, true)
                .duration(200)
                .EUt(VA[LV])
                .save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_titanium_firebox")
                ...
                .outputItems(GTBlocks.FIREBOX_TITANIUM, RecipeConfig.CASINGS_PER_CRAFT.get())
                .addMaterialInfo(true, true)
                .duration(300)
                .EUt(VA[HV])
                .save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_tungstensteel_firebox")
                ...
                .outputItems(GTBlocks.FIREBOX_TUNGSTENSTEEL, RecipeConfig.CASINGS_PER_CRAFT.get())
                .addMaterialInfo(true, true)
                .duration(400)
                .EUt(VA[EV])
                .save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("fusion_casing").EUt(VA[LuV]).inputItems(GTBlocks.MACHINE_CASING_LuV.asStack())
                ...
                .outputItems(GTBlocks.FUSION_CASING.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .addMaterialInfo(true, true)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("fusion_casing_mk2").EUt(VA[ZPM])
                ...
                .outputItems(GTBlocks.FUSION_CASING_MK2.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
        ...
        ASSEMBLER_RECIPES.recipeBuilder("fusion_casing_mk3").EUt(VA[UV])
                ...
                .outputItems(GTBlocks.FUSION_CASING_MK3.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(100).cleanroom(CleanroomType.CLEANROOM)
                .addMaterialInfo(true, true).save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_steel_turbine").EUt(16).inputItems(plate, Magnalium, 6)
                ...
                .outputItems(GTBlocks.CASING_STEEL_TURBINE.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50)
                .addMaterialInfo(true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_stainless_steel_turbine").EUt(16)
                ...
                .outputItems(GTBlocks.CASING_STAINLESS_TURBINE.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50)
                .addMaterialInfo(true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_titanium_turbine").EUt(16)
                ...
                .outputItems(GTBlocks.CASING_TITANIUM_TURBINE.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50)
                .addMaterialInfo(true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("casing_tungstensteel_turbine").EUt(16)
                ...
                .outputItems(
                        GTBlocks.CASING_TUNGSTENSTEEL_TURBINE.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(50)
                .addMaterialInfo(true).save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_grate_casing")
                ...
                .outputItems(GTBlocks.CASING_GRATE, RecipeConfig.CASINGS_PER_CRAFT.get())
                .duration(800)
                .EUt(VA[IV])
                .save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("assembly_line_casing")
                ...
                .inputItems(frameGt, TungstenSteel)
                .outputItems(GTBlocks.CASING_ASSEMBLY_LINE, RecipeConfig.CASINGS_PER_CRAFT.get())
                .duration(650)
                .EUt(VA[IV])
                .save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("assembly_control_casing")
                ...
                .inputItems(frameGt, TungstenSteel)
                .outputItems(GTBlocks.CASING_ASSEMBLY_CONTROL, RecipeConfig.CASINGS_PER_CRAFT.get())
                .duration(650)
                .EUt(VA[IV])
                .save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("plascrete").EUt(48).inputItems(frameGt, Steel)
                ...
                .outputItems(GTBlocks.PLASTCRETE.asStack(RecipeConfig.CASINGS_PER_CRAFT.get())).duration(200)
                .addMaterialInfo(true, true).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("cleanroom_glass").EUt(48).inputItems(frameGt, Steel)
                ...
                .outputItems(GTBlocks.CLEANROOM_GLASS.asStack(RecipeConfig.CASINGS_PER_CRAFT.get()))
                .duration(200)
                .addMaterialInfo(true, true).save(provider);
