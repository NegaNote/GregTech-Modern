...
public class RecipeConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Boolean> GENERATE_LOW_QUALITY_GEMS;
    public static final ForgeConfigSpec.ConfigValue<Boolean> DISABLE_MANUAL_COMPRESSION;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARDER_RODS;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARDER_BRICK_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> NERF_WOOD_CRAFTING;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARD_WOOD_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARD_IRON_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARD_REDSTONE_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARD_TOOL_ARMOR_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARD_MISC_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARD_GLASS_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> NERF_PAPER_CRAFTING;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARD_ADVANCED_IRON_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARD_DYE_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARDER_CHARCOAL_RECIPE;
    public static final ForgeConfigSpec.ConfigValue<Boolean> FLINT_AND_STEEL_REQUIRE_STEEL;
    public static final ForgeConfigSpec.ConfigValue<Boolean> REMOVE_VANILLA_BLOCK_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> REMOVE_VANILLA_TNT_RECIPE;
    public static final ForgeConfigSpec.ConfigValue<Integer> CASINGS_PER_CRAFT;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARDER_CIRCUIT_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> HARD_MULTI_RECIPES;
    public static final ForgeConfigSpec.ConfigValue<Boolean> ENCHANTED_TOOLS;
    public static final ForgeConfigSpec.ConfigValue<Boolean> ENABLE_MACERATOR_RECYCLING;
    public static final ForgeConfigSpec.ConfigValue<Float> MACERATOR_RECYCLING_YIELD;
    public static final ForgeConfigSpec.ConfigValue<Boolean> ENABLE_ARC_RECYCLING;
    public static final ForgeConfigSpec.ConfigValue<Float> ARC_RECYCLING_YIELD;
    public static final ForgeConfigSpec.ConfigValue<Boolean> ENABLE_EXTRACTOR_RECYCLING;
