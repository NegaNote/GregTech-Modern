...
public class OreVeinConfig {
    ...
    public static ForgeConfigSpec.ConfigValue<Boolean> REMOVE_VANILLA_ORE_GEN;
    public static ForgeConfigSpec.ConfigValue<Boolean> REMOVE_VANILLA_LARGE_ORE_VEINS;
    public static ForgeConfigSpec.ConfigValue<Integer> BEDROCK_ORE_DISTANCE;
    public static ForgeConfigSpec.ConfigValue<Boolean> INFINITE_BEDROCK_ORES_FLUIDS;
    public static ForgeConfigSpec.ConfigValue<Boolean> ORE_INDICATORS;
