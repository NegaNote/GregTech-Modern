...
public class OreVeinConfig {
    ...
    public static ForgeConfigSpec.IntValue ORE_VEIN_GRID_SIZE;
    public static ForgeConfigSpec.IntValue ORE_VEIN_RANDOM_OFFSET;
    ...
    public static ForgeConfigSpec.IntValue BEDROCK_ORE_DISTANCE;
    ...
    public static ForgeConfigSpec.IntValue ORE_GENERATION_CHUNK_CACHE_SIZE;
    public static ForgeConfigSpec.IntValue ORE_INDICATOR_CHUNK_CACHE_SIZE;
}
